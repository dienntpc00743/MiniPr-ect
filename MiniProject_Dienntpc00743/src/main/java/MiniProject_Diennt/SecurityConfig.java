...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable();
		http.authorizeRequests().antMatchers("/oder/**").authenticated().antMatchers("/admin/**")
				.hasAnyRole("ADMIN","PM").antMatchers("/rest/authorities").hasRole("ADMIN").anyRequest().permitAll();
		...
		http.logout().logoutUrl("/security/logoff").logoutSuccessUrl("/product/list");
	}
